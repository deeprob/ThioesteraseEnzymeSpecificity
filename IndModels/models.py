...
class PosModel:
    ...
    def __init__(self,pickle_file_path,enzs,X,y,tr_idx,te_idx,SVM=True,GBC=False,pca_components=40,regCparam=1,kernparam='linear',nestparam=100,lrateparam=0.1,mdepthparam=1,ssampleparam=1,random_seed=None,optimizeQ=False,verboseQ=False):
...
class NGModel:
    # NGram model
    def __init__(self,enzs,X,y,tr_idx,te_idx,k=7,s=1,SVM=True,GBC=False,pca_components=40,regCparam=1,kernparam='linear',nestparam=100,lrateparam=0.1,mdepthparam=1,ssampleparam=1,random_seed=None,optimizeQ=False,verboseQ=False):
...
class GAACModel:
    # GAAC-NGram model
    def __init__(self,enzs,X,y,tr_idx,te_idx,k=7,s=1,SVM=True,GBC=False,pca_components=40,regCparam=20,kernparam='rbf',nestparam=15,lrateparam=0.5,mdepthparam=3,ssampleparam=1,optimizeQ=False,verboseQ=False,random_seed=None):
